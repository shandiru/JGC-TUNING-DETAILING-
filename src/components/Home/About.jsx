...
const testimonials = [
{
    "text": "I had Jordan come and remap my car after having faults with my RS3 going into limp home mode previously being tuned by a highly reputable company. The can now runs perfect without any hiccups!Great knowledge and customer service!",
    "name": "Diana Chęć"
  },
];
