...
const services = [
  {
    title: "PREMIUM MOBILE TUNING",
    desc: "Expert ECU recalibration delivered to your doorstep across Lincolnshire for enhanced power and efficiency.",
    image: "/services/tuning.avif",
    path: "/services/mobile-tuning",
  },
  {
    title: "PERFORMANCE REMAPPING",
    desc: "Unlock your engine's true potential with precision software stages designed for peak performance.",
    image: "/services/remapping.avif",
    path: "/services/remapping",
  },
  {
    title: "EXECUTIVE DETAILING",
    desc: "A meticulous multi-stage restoration process to achieve a flawless, high-gloss finish and protection.",
    image: "/services/detailing.avif",
